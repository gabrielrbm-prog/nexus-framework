...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Fallback: ensure elements are visible even without JS/scroll */
    .gsap-reveal { animation: gsapFallback 0.01s 2s forwards; }
    @keyframes gsapFallback { to { opacity: 1 !important; transform: none !important; } }
...
<body>
  ...
  <script>
    ...
    // Refresh after hash navigation and force reveal
    setTimeout(() => {
      ScrollTrigger.refresh();
      // Force-reveal all elements that ScrollTrigger missed
    ...
    /* Fallback: ensure all gsap-reveal elements are visible after animations */
    setTimeout(function() {
